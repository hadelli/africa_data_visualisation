class ChoroplethMap {
    ...
    // New method to handle language selection
    updateMapForLanguage(selectedLanguage) {
        // Remove the 'highlighted' class from all countries
        this.svg.selectAll(".country").classed("highlighted", false);

        // Highlight countries that speak the selected language
        this.svg.selectAll(".country")
            .filter(d => (this.languageMap.get(d.properties.name) || []).includes(selectedLanguage))
