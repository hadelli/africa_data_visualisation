class ChoroplethMap {
    ...
    updateMapForPopulationDensity(selectedPopulationDensity) {
        console.log("Slider value:", selectedPopulationDensity);
    
        // Remove the 'highlighted' class from all countries
        this.svg.selectAll(".country").classed("highlight", false);
        selectedPopulationDensity = +selectedPopulationDensity;
    
        // Highlight countries with valid and non-null population density less than or equal to the selected value
        this.svg.selectAll(".country")
        .filter(d => d.properties.pop_density && +d.properties.pop_density <= selectedPopulationDensity)
    ...
    updateVis() {
        ...
        vis.legendStops = [
            { color: '#f2cff0', value: popDensityExtent[0], offset: 0 },
            { color: '#490d6b', value: popDensityExtent[1], offset: 100 },
        ];
        vis.renderVis();
    }
    renderVis() {
